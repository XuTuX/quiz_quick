                ...
                <Card className="w-full max-w-lg text-center">
                    ...
                    <CardContent>
                        ...
                        <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Button onClick={onReset} variant="outline" className="flex-1"><Home className="mr-2 h-4 w-4" />처음으로</Button>
                        </div>
                    </CardContent>
                </Card>
            </main>
            ...
            <Card className="w-full max-w-2xl">
                ...
                <CardContent>
                    ...
                    <div className="space-y-3">
                        ...
                        ) : (showAnswer ? <div className="p-4 bg-green-100 border rounded-md"><p className="font-bold">정답:</p><p>{currentQuestion.answer}</p></div> : <p className="text-muted-foreground">주관식 문제입니다. 정답을 확인해보세요.</p>)}
                    </div>
                </CardContent>
                <CardFooter className="flex justify-between items-center">
                    <Button variant="ghost" onClick={onReset}><Home className="mr-2 h-4 w-4" />처음으로</Button>
                    <div className="flex gap-4">
                        ...
                        {showAnswer && <Button onClick={goToNextQuestion}>다음 문제 <ArrowRight className="ml-2 h-4 w-4" /></Button>}
                    </div>
                </CardFooter>
            </Card>
        </main>
